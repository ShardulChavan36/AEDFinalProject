 ...
 * @author Shardul
 */
public class DiagnosticLab extends Organization{
    public String donorLabName;
  
    public DiagnosticLab(String enterpriseName, String registrationNo, String address, String username, String password,String orgName, String orgusername, String orgpassword){
