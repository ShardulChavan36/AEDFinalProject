...
//      dataset.setValue( "IPhone 5s" , new Double( 20 ) );  
    ...
    private ChartPanel createEntityRecChartPanel() {
        ...
        JFreeChart chart = ChartFactory.createBarChart("No. of Lives Saved", "Receiving Enterprises.",
            "Count", dc, PlotOrientation.HORIZONTAL, false, false, false);
        return new ChartPanel(chart) {
            @Override
            public Dimension getPreferredSize() {
                return new Dimension(N * 2, N * 2);
    ...
    private ChartPanel createEntityEnterpriseChartPanel() {
        ...
        JFreeChart chart = ChartFactory.createBarChart("No. of Donations from Enterprises", "Donor Enterprises",
    ...
    private ChartPanel createEntityNameChartPanel() {
        ...
        JFreeChart chart = ChartFactory.createBarChart("", "Total Donations(organ/blood)",
            "Range", dc, PlotOrientation.VERTICAL, false, false, false);
        return new ChartPanel(chart) {
            @Override
            public Dimension getPreferredSize() {
