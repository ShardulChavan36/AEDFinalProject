...
public class DonorAdminDonateOrgan extends javax.swing.JPanel {
    ...
    public DonorAdminDonateOrgan(MainFrame mainScreen, DB4OUtil dB4OUtil, EcoSystem ecoSystem, DonorInventory donbank) {
        initComponents();
        ...
        for(DonorDetails pa : ecoSystem.getDonordirectory() ){
            System.out.println("DonorAdminDonateOrgan"+pa.getInventoryName());
            if( pa.getInventoryName().equals(donbank.getEnterpriseName())){
                donlist.addItem(pa.getEmaildId());
            }
        }
    }
    ...
    private void initComponents() {
        ...
        lbl_donorname.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl_donorname.setText("Donor Name:");

        lbl_enttype.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        lbl_entname.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl_entname.setText("Entity Name:");

        lbl_bldgrp.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
